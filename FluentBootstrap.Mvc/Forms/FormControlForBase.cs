...
namespace FluentBootstrap.Mvc.Forms
{
    public abstract class FormControlForBase : FormControl
    {
        ...
        public string Placeholder { get; set; } //Add For EditorFor By Jubpas
            ...
            if (AddFormControlClass)
            {
                ...
                foreach (HtmlNode node in doc.DocumentNode.ChildNodes)
                {
                        ...
                        || node.Name == "select")
                    {
                        ...
                        //add Placeholder By Jubpas
                        if (Placeholder != "" && node.Attributes.Contains("placeholder") == false)
                        {
                            node.Attributes.Add("placeholder", Placeholder);
                        }
                    }
