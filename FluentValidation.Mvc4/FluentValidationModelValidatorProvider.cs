...
namespace FluentValidation.Mvc
{
    ...
    public class FluentValidationModelValidatorProvider : ModelValidatorProvider
    {
        ...
        private Dictionary<Type, FluentValidationModelValidationFactory> validatorFactories = new Dictionary<Type, FluentValidationModelValidationFactory>() {
            ...
            { typeof(GreaterThanOrEqualValidator), (metadata, context, rule, validator) => new GreaterThanOrEqualFluentValidationPropertyValidator(metadata, context, rule, validator) },
            { typeof(LessThanOrEqualValidator), (metadata, context, rule, validator) => new LessThanOrEqualFluentValidationPropertyValidator(metadata, context, rule, validator) },
            ...
            { typeof(ActiveAndStatusMatchValidator), (metadata, context, description, validator) => new ActiveAndStatusMatchPropertyValidator(metadata, context, description, validator) },//Add By Waiantarai 2016-12-16,
            { typeof(FluentValidationPropertyValidator), (metadata, context, description, validator) => new ActiveAndStatusMatchPropertyValidator(metadata, context, description, validator) },
            { typeof(StoreValidator), (metadata, context, description, validator) => new StorePropertyValidator(metadata, context, description, validator) },//Add By Waiantarai 2017-01-12
            { typeof(IDCardValidator), (metadata, context, description, validator) => new IDCardFluentValidationPropertyValidator(metadata, context, description, validator) },
            { typeof(NotFileExeBatValidator), (metadata, context, description, validator) => new NotFileExeBatFluentValidationPropertyValidator(metadata, context, description, validator) },
            { typeof(CheckPasswordValidator), (metadata, context, description, validator) => new CheckPasswordFluentValidationPropertyValidator(metadata, context, description, validator) },
            { typeof(EqualAfterValidator), (metadata, context, rule, validator) => new EqualToAfterFluentValidationPropertyValidator(metadata, context, rule, validator) },//Add By Waiantarai 2017-04-12
            { typeof(CheckBoxCheckValidator), (metadata, context, rule, validator) => new CheckBoxCheckValidationPropertyValidator(metadata, context, rule, validator) },
            { typeof(NotEmptyWithCheckboxValidator), (metadata, context, rule, validator) => new NotEmptyWithCheckboxFluentValidationPropertyValidator(metadata, context, rule, validator) }
        };
