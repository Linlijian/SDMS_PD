namespace FluentValidation.Mvc
{
    ...
    internal class NotFileExeBatFluentValidationPropertyValidator : FluentValidationPropertyValidator
    {
        private NotFileExeBatValidator NotFileExeBatValidator
        {
            get { return (NotFileExeBatValidator)Validator; }
        }

        public NotFileExeBatFluentValidationPropertyValidator(ModelMetadata metadata, ControllerContext controllerContext, PropertyRule rule, IPropertyValidator validator) : base(metadata, controllerContext, rule, validator)
        {
