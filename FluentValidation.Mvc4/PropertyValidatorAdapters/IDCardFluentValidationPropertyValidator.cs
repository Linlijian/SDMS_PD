namespace FluentValidation.Mvc
{
    ...
    internal class IDCardFluentValidationPropertyValidator : FluentValidationPropertyValidator
    {
        private IDCardValidator IDCardValidator
        {
            get { return (IDCardValidator)Validator; }
        }

        public IDCardFluentValidationPropertyValidator(ModelMetadata metadata, ControllerContext controllerContext, PropertyRule rule, IPropertyValidator validator) : base(metadata, controllerContext, rule, validator)
        {
        ...
        public override IEnumerable<ModelClientValidationRule> GetClientValidationRules()
        {
            ...
            var propertyToCompare = IDCardValidator.MemberToCompare as PropertyInfo;
            if (propertyToCompare != null)
            {
                ...
                string message = formatter.BuildMessage(IDCardValidator.ErrorMessageSource.GetString());

                var rule = new ModelClientValidationRule
                {
                    ErrorMessage = message, // default error message
                    ValidationType = "idcard" // name of the validatoin which will be used inside unobtrusive library
                };
