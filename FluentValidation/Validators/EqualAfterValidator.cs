...
namespace FluentValidation.Validators
{
    ...
    public class EqualAfterValidator : PropertyValidator, IComparisonValidator
    {
        readonly Func<object, object> func;
        readonly IEqualityComparer comparer;

        public EqualAfterValidator(object valueToCompare) : base(nameof(Messages.equal_error), typeof(Messages))
        {
            this.ValueToCompare = valueToCompare;
        }

        public EqualAfterValidator(object valueToCompare, IEqualityComparer comparer)
        ...
        public EqualAfterValidator(Func<object, object> comparisonProperty, MemberInfo member)
            : base(nameof(Messages.equal_error), typeof(Messages))
        {
        ...
        public EqualAfterValidator(Func<object, object> comparisonProperty, MemberInfo member, IEqualityComparer comparer)
            : base(nameof(Messages.equal_error), typeof(Messages))
        {
            func = comparisonProperty;
            MemberToCompare = member;
