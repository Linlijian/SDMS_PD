...
namespace FluentBootstrap
{
    public static class TagExtensions
    {
        ...
        public static ComponentBuilder<TConfig, TTag> SetCascading<TConfig, TTag>(this ComponentBuilder<TConfig, TTag> builder, object actionUrl, string selectTarget)
           where TConfig : BootstrapConfig
           where TTag : Tag
        {

            builder.Component.MergeAttribute("data-url", Convert.ToString(actionUrl, CultureInfo.InvariantCulture));
            builder.Component.MergeAttribute("data-target", selectTarget);
            builder.Component.AddCss("cascading-select");
            return builder;
        }
        ...
        //data-keySource="PROGRAM" data-BindField="Data1" data-SetValue=""
        public static ComponentBuilder<TConfig, TTag> JAutoKeySource<TConfig, TTag>(this ComponentBuilder<TConfig, TTag> builder, object value)
           where TConfig : BootstrapConfig
           where TTag : Tag
        {
            builder.Component.MergeAttribute("data-keySource", Convert.ToString(value, CultureInfo.InvariantCulture));
            return builder;
        }
        public static ComponentBuilder<TConfig, TTag> JAutoBindField<TConfig, TTag>(this ComponentBuilder<TConfig, TTag> builder, object value)
          where TConfig : BootstrapConfig
          where TTag : Tag
        {
            builder.Component.MergeAttribute("data-bindfield", Convert.ToString(value, CultureInfo.InvariantCulture));
            return builder;
        }

        public static ComponentBuilder<TConfig, TTag> JAutoFieldToInput<TConfig, TTag>(this ComponentBuilder<TConfig, TTag> builder, object value)
        where TConfig : BootstrapConfig
        where TTag : Tag
        {
            var newValue = Newtonsoft.Json.JsonConvert.SerializeObject(value);
            builder.Component.MergeAttribute("data-fieldtoinput", newValue);
            return builder;
        }

        public static ComponentBuilder<TConfig, TTag> JAutoSetExtraParams<TConfig, TTag>(this ComponentBuilder<TConfig, TTag> builder, object value)
      where TConfig : BootstrapConfig
      where TTag : Tag
        {
            var newValue = Newtonsoft.Json.JsonConvert.SerializeObject(value);
            builder.Component.MergeAttribute("data-extraparams", newValue);
            return builder;
        }

        public static ComponentBuilder<TConfig, TTag> JAutoSetExtraParamsByCtrl<TConfig, TTag>(this ComponentBuilder<TConfig, TTag> builder, object value)
     where TConfig : BootstrapConfig
     where TTag : Tag
        {
            builder.Component.MergeAttribute("data-paramsctrl", Convert.ToString(value, CultureInfo.InvariantCulture));
            return builder;
        }
        public static ComponentBuilder<TConfig, TTag> JAutoSetDefaultValue<TConfig, TTag>(this ComponentBuilder<TConfig, TTag> builder, object value)
        where TConfig : BootstrapConfig
        where TTag : Tag
        {
            builder.Component.MergeAttribute("data-setvalue", Convert.ToString(value, CultureInfo.InvariantCulture));
            return builder;
        }
        public static ComponentBuilder<TConfig, TTag> SetSelectOnly<TConfig, TTag>(this ComponentBuilder<TConfig, TTag> builder, bool value = true)
        where TConfig : BootstrapConfig
        where TTag : Tag
        {
            builder.Component.MergeAttribute("data-selectedonly", Convert.ToString(value, CultureInfo.InvariantCulture).ToLower());
            return builder;
        }
        #endregion
        ...
        public static ComponentBuilder<TConfig, TTag> SetMaxLength<TConfig, TTag>(this ComponentBuilder<TConfig, TTag> builder, object value)
            where TConfig : BootstrapConfig
            where TTag : Tag
        {
            builder.Component.MergeAttribute("maxlength", Convert.ToString(value, CultureInfo.InvariantCulture));
            return builder;
        }
        public static ComponentBuilder<TConfig, TTag> SetIndexParameter<TConfig, TTag>(this ComponentBuilder<TConfig, TTag> builder, int index)
            where TConfig : BootstrapConfig
            where TTag : Tag
        {
            builder.Component.MergeAttribute("data-indexparameter", Convert.ToString(index, CultureInfo.InvariantCulture));
            return builder;
        }
    }
}
