...
namespace FluentBootstrap
{
    public static class TableExtensions
    {
        ...
        public static ComponentBuilder<TConfig, Table> SetType<TConfig>(this ComponentBuilder<TConfig, Table> builder, TableType type)
           where TConfig : BootstrapConfig
        {
            builder.Component.MergeAttribute("data-tabletype",type.GetDescription());
            return builder;
        }
