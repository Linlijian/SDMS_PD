...
namespace FluentBootstrap.Forms
{
        ...
        ICanCreate<HelpBlock>
    {
        ...
        public HtmlString ValidationMessageTag { get; set; }
        ...
        public void Prepare(TextWriter writer)
        {
            ...
            if (IsRequired && _label != null)
            {
                _wrapper.CssClasses.Add("required");
            }
        ...
        protected override void OnFinish(TextWriter writer)
        {
            ...
            if (AddValidationMessage && ValidationMessageTag != null)
            {
                writer.Write(ValidationMessageTag);
            }
